...
public class CameraActivity extends AppCompatActivity {
    ...
    private final boolean isFont = false;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.ml1_activity_camera);
        if (!hasPermission()) {
            requestPermission();
        }
        ...
        ClassificationImageUtils.copyFileFromAsset(CameraActivity.this, "ml1_mobilenet_v2.tflite", classificationModelPath);
        try {
    ...
    private void startCapture() {
        ...
        try {
            ...
            assert map != null;
            mPreviewSize = ClassificationImageUtils.chooseOptimalSize(map.getOutputSizes(SurfaceTexture.class),
